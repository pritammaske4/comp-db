...
public class RetrieveComputerRecordData extends BaseTestScript {

    @Test(description = "Test Script to retrieve computer record data",dataProvider = "compDBDataProvider")
