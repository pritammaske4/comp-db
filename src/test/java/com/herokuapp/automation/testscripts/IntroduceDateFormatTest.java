...
public class IntroduceDateFormatTest extends BaseTestScript {
    @Test(description = "Test Script to verify Introduce Date Error Message",dataProvider = "compDBDataProvider")
    public void introduceDateFormatTest(String computerName,String introduceDate,String discontinuedDate,String company){
        ...
        Assert.assertEquals(NewComputerPage.isIntroduceDateFormatErrorMsgVisible(),true,"Introduce Date Format Error message not displayed");
        extentTest.log(LogStatus.PASS, "Successfully verified Introduce Date Format Error message");
